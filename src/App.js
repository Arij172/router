  ...
  const [movies, setMovies] = useState([
    {
      ...
      rating: 8.8,
      trailerLink:"https://www.youtube.com/watch?v=CoXtvSRpHgM",
    },
    {
      title: "Barbie",
      ...
      rating: 7.5,
      trailerLink:"https://www.youtube.com/watch?v=2oOzWcbVf1c",
    },
    ...
    <div className="app">
      ...
      <Switch>
        <Route path="/movie/:title">
          {/* Pass movies prop to MovieDescription component */}
          <MovieDescription movies={movies} />
        </Route>
        <Route exact path="/">
          {/* Pass filteredMovies prop to Home component */}
